...
2.  **New sentences to respond to your users.** There are several sentences and responses that you will want to customize for your skill.
    ...
    1.  **Go back to your copy of [index.js](https://github.com/alexa/skill-sample-nodejs-city-guide/blob/en-US/lambda/custom/index.js).**
...
[![Next](https://m.media-amazon.com/images/G/01/mobile-apps/dex/alexa/alexa-skills-kit/tutorials/general/buttons/button_next_publication._TTH_.png)](6-publication)
